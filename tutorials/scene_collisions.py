...
def main():
    ...
    params_to_optimize = args.params_to_optimize  # key_pose, 'transl', 'global_orient'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--params_to_optimize', nargs='+', default=['body_pose'], type=str, help='List of parameters to optimize.')
